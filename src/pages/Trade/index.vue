  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="setDefault(address, addressInfo)">
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      //其余的六个参数
      let data = {
        consignee: this.userAddressInfo.consignee,  //收件人名字
        consigneeTel: this.userAddressInfo.phoneNum, //电话
